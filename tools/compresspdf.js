async function rendercompresspdf(container) {
 ...
 After compression, you can also <a href="/pages/pdfencrypt.html" target="_self">password protect your PDF</a>.
 </p>
 ...
 <div aria-hidden="true" style="font-size: 2.5rem; margin-bottom: 0.5rem;"></div>
 ...
 <strong>Image mode</strong> removes text selectability and search. Best for photos and scanned PDFs. <strong>Safe mode</strong> also re-renders pages but at higher quality (less aggressive compression).
 </div>
 </div>
