// pdf2jpg.js — Visual PDF-to-JPG Converter (Memory & Tab Crash Optimized)
        ...
        btn.addEventListener('click', async () => {
            ...
            try {
                ...
                for (let i = 0; i < pagesToExtract.length; i++) {
                    ...
                    // Create virtual offscreen canvas
                    ...
                    // Tab memory crash guard: only load actual visual graphic preview in DOM for first 12 pages
                    ...
                    if (shouldRenderVisual) {
                        ...
                        // Render a lightweight vector file icon for page 13+ to avoid GPU overload
                        ...
                        placeholder.innerHTML = `<span style="font-size:1.8rem; margin-bottom:4px;">🖼️</span><span style="font-size:0.7rem; color:var(--text-muted);">Memory Saved</span>`;
                    ...
                    // Yield main thread every 3 page renders
