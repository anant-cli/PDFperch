async function renderqrmaker(container) {
 ...
 <textarea id="qrText" placeholder="Enter text or URL (one per line for batch generation)" style="width: 100%; min-height: 80px; padding: 0.8rem; border-radius: var(--r-md); border: 1px solid var(--border-subtle); margin-bottom: 1rem; font-family: inherit;">https://pdfperch-7xd.pages.dev</textarea>
